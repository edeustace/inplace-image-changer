  ...
  */
  ...
  this.com.ee.InplaceImageUploader = (function() {
    ...
    InplaceImageUploader.prototype._onLocalFileLoadEnd = function(evt) {
      ...
      xhr.open("POST", this.$element.attr('form-url'), true);
      xhr.setRequestHeader('content-type', "multipart/form-data; boundary=" + boundary);
      xhr.setRequestHeader("Accept", "application/json");
      xhr.sendAsBinary(formBody);
      this.options.onLoadStart(this.$element);
      xhr.onload = function() {
        return _this.options.onUploadComplete(_this.$element, xhr.responseText);
      };
      return null;
    };

    InplaceImageUploader.prototype._buildMultipartFormBody = function(file, fileBinaryData, boundary) {
      ...
      fileParams = [
        {
          file: file,
          data: fileBinaryData,
          paramName: this.$element.attr('form-name')
        }
      ];
